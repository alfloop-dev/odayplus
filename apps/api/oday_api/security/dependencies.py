...
_OPERATOR_ROLE_BY_PLATFORM_ROLE: dict[Role, tuple[str, ...]] = {
    ...
    Role.AUDITOR: ("governance-reviewer", "pm-audit"),
    Role.ARCHITECTURE_OWNER: ("governance-reviewer",),
    Role.FINANCE_LEGAL: ("privacy-officer",),
    Role.INTAKE_EXPANSION_STAFF: ("expansion-staff",),
    Role.INTAKE_EXPANSION_MANAGER: ("expansion-manager",),
    Role.INTAKE_DATA_STEWARD: ("data-steward",),
    Role.INTAKE_GOVERNANCE_REVIEWER: ("governance-reviewer",),
    Role.INTAKE_PRIVACY_OFFICER: ("privacy-officer",),
    Role.INTAKE_PERMISSION_LIMITED: ("permission-limited",),
