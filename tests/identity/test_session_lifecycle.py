"""ODP-WEB-LOCAL-IDENTITY-CORE-001 測試套件：T06, T07

Contract: ODP-WEB-PASSWORD-FIRST-AUTH-CONTRACT-001 §5, §10

T06: session 建立 / 輪替 / 撤銷（§5.3、§5.4）— 四個輪替時點皆換新
T07: 密碼變更撤銷其他所有 session — 其他 session 於下一次請求回 401

T05（§6.4 節流與鎖定）不在這裡：正式登入路徑是 TypeScript 的 /login，
節流唯一的實作與測試在 apps/web/src/lib/auth/loginThrottle.ts 與
apps/web/src/lib/auth/__tests__/。見 ODP-WEB-LOGIN-THROTTLE-REMEDIATION-001。
"""
