...
POSTGRES_MIGRATION = Path("infra/db/migrations/000024_avm_quality_score_nullable.sql")
SQLITE_MIGRATION = Path("infra/db/migrations/000024_avm_quality_score_nullable_sqlite.sql")
