...
export const netPlanScenarioFixture: NetPlanScenarioCardContract = {
  ...
  modelledConstraintClasses: ["CAPITAL", "CONSTRUCTION", "COVERAGE"],
  unmodelledConstraintClasses: ["LEASE", "EQUIPMENT", "LABOUR", "DILUTION", "SEQUENCING"],
  modelled_constraint_classes: ["CAPITAL", "CONSTRUCTION", "COVERAGE"],
  unmodelled_constraint_classes: ["LEASE", "EQUIPMENT", "LABOUR", "DILUTION", "SEQUENCING"],
