...
REQUIRED_BOARD_TOKENS = (
    ...
    "python3 delivery_toolchain/e2e/check_product_closeout_action.py",
    "python3 delivery_toolchain/e2e/check_product_closeout_action_matrix.py",
    "python3 delivery_toolchain/e2e/sync_product_closeout_fleet_comment.py",
    ...
    "python3 delivery_toolchain/e2e/update_external_proof_handback_status_board.py",
    ...
    "python3 delivery_toolchain/e2e/check_external_proof_handback_artifact.py",
