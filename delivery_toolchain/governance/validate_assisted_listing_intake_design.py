...
def main() -> int:
    ...
    builder = read("delivery_toolchain/openapi/build_validate_assisted_listing_intake.py")
    ...
    workflow_uses_manifest_openapi = (
        "delivery_toolchain/openapi/build_validate_assisted_listing_intake.py" in openapi_step
