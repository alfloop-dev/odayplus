...
| `ODP-FE-R0-001` | `review_approved` | Claude | `owner_done` | `owner_status_closeout` | `AI_NAME=Claude python3 scripts/ai_status.py done ODP-FE-R0-001 "<finalization message>"` | `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/evidence/FRONTEND_FLEET_COMPLETION_AUDIT.md` |
| `ODP-FE-EXP-001` | `review` | Claude | `reviewer_approve_or_reopen` | `reviewer_status_closeout` | `AI_NAME=Claude REVIEW_NOTES_ZH="<review summary>" python3 scripts/ai_status.py approve ODP-FE-EXP-001 "<approval message>"` or `AI_NAME=Claude python3 scripts/ai_status.py reopen ODP-FE-EXP-001 "<missing evidence>"` | `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/design/ODAY_PLUS_EXPANSION_WORKFLOW_BLUEPRINT.md`, `docs/design/ODAY_PLUS_HEATZONE_MAP_VISUAL_SPEC.md`, `docs/design/ODAY_PLUS_SITESCORE_REPORT_UI_SPEC.md` |
| `ODP-FE-ASSET-001` | `in_progress` | Claude | `owner_handoff` | `owner_status_closeout` | `AI_NAME=Claude python3 scripts/ai_status.py handoff ODP-FE-ASSET-001 Codex2 "<handoff message>"` | `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/design/ODAY_PLUS_ASSET_AND_NETPLAN_UI_SPEC.md` |
| `ODP-FE-ASSET-001` | `waiting_for_review_after_handoff` | Codex2 | `reviewer_approve_or_reopen` | `reviewer_status_closeout` | `AI_NAME=Codex2 REVIEW_NOTES_ZH="<review summary>" python3 scripts/ai_status.py approve ODP-FE-ASSET-001 "<approval message>"` or `AI_NAME=Codex2 python3 scripts/ai_status.py reopen ODP-FE-ASSET-001 "<missing evidence>"` | `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/design/ODAY_PLUS_ASSET_AND_NETPLAN_UI_SPEC.md` |
...
| `ODP-FE-OPS-001` | `done` | `docs/evidence/ODP_FE_OPS_001_CLOSEOUT.md`, `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/evidence/FRONTEND_FLEET_COMPLETION_AUDIT.md` |
| `ODP-FE-PRICE-001` | `done` | `docs/evidence/ODP_FE_PRICE_001_CLOSEOUT.md`, `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/evidence/FRONTEND_FLEET_COMPLETION_AUDIT.md` |
| `ODP-FE-LEARN-001` | `done` | `docs/evidence/LEGACY_WORKSPACE_UI_RETIREMENT.md`, `docs/evidence/FRONTEND_FLEET_COMPLETION_AUDIT.md` |
...
- `python3 scripts/e2e/check_external_proof_issue_handback_scan.py --report --fail-on-escalation`
  ...
  every #132-#138 issue after the latest current-SHA pickup, and fails once a
  no-handback row is overdue.
