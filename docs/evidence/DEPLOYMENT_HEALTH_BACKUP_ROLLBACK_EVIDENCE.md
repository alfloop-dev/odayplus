...
| Remote staging rollout | blocked | `.github/workflows/deploy-staging.yml` now fails closed through `delivery_toolchain/e2e/check_remote_staging_proof.py`; staging host/API URL/secret owner and backing services are still not configured |
