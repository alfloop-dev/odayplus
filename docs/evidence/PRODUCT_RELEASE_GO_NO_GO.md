...
|---|---|---|
| Code/security CI | passed | `make ci` in GitHub CI, security high/critical dependency gate |
...
| Product Docker E2E | passed when `scripts/e2e/run_product_e2e.sh` passes | Docker API/web/worker/source-stub stack, 8 Playwright tests after PV-007 |
