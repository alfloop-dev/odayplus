...
2. **Release drill harness** — `scripts/release/assisted_listing_intake/`
   ...
   `tests/ops/test_assisted_listing_intake_release.py` (36 tests), including
   ...
   error-budget-exhausted production canary evidence, cached-report forgery,
   and supports native YAML timestamp values.
