#!/usr/bin/env python3
"""Re-verify the live-artifact binding recorded by ODP-DEV-CANDIDATE-GATE-RECONCILIATION-002.
...
* ``sources_off_attestation`` audits all 16 sources as disabled with zero credentials
  and default-deny egress;
* ``initial_release_recovery`` binds target absence readback for dev initial deployment;
...
Usage:  python3 docs/evidence/runtime/ODP-DEV-CANDIDATE-GATE-RECONCILIATION-002/verify_live_artifact_binding.py
...
def main() -> int:
    ...
    # sources-off attestation checks
