...
| `heatzone_topk_adoption_rate` | Gauge | business | - | `apps/api/oday_api/routes/heatzone.py` (measured survey adoption lineage) | `ProductionMetricsExporter` | `custom.googleapis.com/heatzone_topk_adoption_rate` | `test_round9_remediation_findings_b1_b4_verified` |
