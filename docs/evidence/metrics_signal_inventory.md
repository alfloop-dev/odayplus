...
| `heatzone_topk_adoption_rate` | Gauge | business | - | `apps/api/oday_api/routes/heatzone.py` (NO-GO / unmeasured; measured survey adoption lineage absent) | ProductionMetricsExporter | custom.googleapis.com/heatzone_topk_adoption_rate | `test_round10_remediation_findings_b1_b4_verified` |
