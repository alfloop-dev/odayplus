...
ARG NEXT_PUBLIC_ODP_API_BASE_URL
...
ENV ODP_API_BASE_URL=$ODP_API_BASE_URL \
    NEXT_PUBLIC_ODP_API_BASE_URL=$NEXT_PUBLIC_ODP_API_BASE_URL \
    ...
    ODP_DEPLOY_ENV=$ODP_DEPLOY_ENV \
    NEXT_PUBLIC_ODP_DEPLOY_ENV=$ODP_DEPLOY_ENV \
    ODP_E2E_MODE=$ODP_E2E_MODE \
    NEXT_PUBLIC_ODP_E2E_MODE=$ODP_E2E_MODE
